...
HD_PWD='M:/UNI/L2/L2 S4/ELE401/Horloge_ELE401/Horloge_ELE401.runs/Projet_Chronometre_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Projet_Chronometre_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Projet_Chronometre_0_0.tcl
