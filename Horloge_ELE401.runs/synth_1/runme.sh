...
HD_PWD='M:/UNI/L2/L2 S4/ELE401/Horloge_ELE401/Horloge_ELE401.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Projet_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Projet_wrapper.tcl
