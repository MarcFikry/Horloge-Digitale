...
HD_PWD='M:/UNI/L2/L2 S4/ELE401/Horloge_ELE401/Horloge_ELE401.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Projet_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Projet_wrapper.tcl -notrace
